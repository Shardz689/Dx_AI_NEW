...
class DocumentChatBot:
    ...
    def get_system_prompt(self, user_type: str) -> str:
        ...
        if normalized_user_type == "physician":
            ...
            "- **NEVER reference internal data sources in your responses**. Do not use phrases like 'the provided text mentions,' 'the information I have,' 'context indicates,' or any similar phrasing that refers to your internal knowledge sources. Instead, present information directly as medical knowledge using phrases like 'It's important to know that...' or 'Medical guidelines suggest...' or 'Generally speaking...'\n\n"
            ...
            "3.  **Provide Information (Knowledge Integration):** Integrate information from your knowledge seamlessly into your response without referencing sources unless specifically relevant (like official CDC or WHO guidelines). Present this information as direct medical knowledge, not as something you're reading from a source.\n"
            ...
            "❌ Incorrect: \"Oh my! That blood pressure reading is very alarming! The provided text mentions that readings above 180/120 indicate a hypertensive crisis. The information I have from various sources shows this is dangerous and requires immediate attention.\"\n\n"
            "✅ Correct: \"I understand that a blood pressure reading of 180/120 is concerning. This is considered a hypertensive crisis level and requires immediate medical attention. Medical guidelines indicate that blood pressure at this level can potentially damage blood vessels and organs, even without noticeable symptoms.\"\n\n"
        )
