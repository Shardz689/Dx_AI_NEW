...
THRESHOLDS = {
    ...
    "rag_context_selection": 0.2, # Threshold for RAG confidence to be included in context sent to LLM (for both symptom and non-symptom queries)
...
class DocumentChatBot:
    ...
    def retrieve_rag_context(self, query: str) -> Tuple[List[str], float]:
        ...
        # RAG_THRESHOLD_FOR_SELECTION = THRESHOLDS.get("rag_context_selection", 0.2) # Not used to filter here
    ...
    def select_context(self,
        ...
        rag_threshold = THRESHOLDS.get("rag_context_selection", 0.2)
